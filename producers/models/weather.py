...
class Weather(Producer):
    ...
    def run(self, month):
        ...
        #
        #
        logger.info("weather data being generated")
        resp = requests.post(
        ...
        try:
            ...
            logging.error(f"failed to send data via REST: {json.dumps(resp.json(), indent=2)}")
        logging.debug("REST connection and data sent successfully")
